        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-instagram-blue rounded-full flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
                <div className="w-12 h-12 bg-instagram-blue rounded-lg mb-4"></div>
                <h3 className="text-xl font-bold mb-2">{service.name}</h3>
                <p className="text-gray-600 mb-4">{service.desc}</p>
                <Link to="/services" className="text-instagram-blue font-semibold hover:underline">Learn More →</Link>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div>
              ...
              <Link to="/contact" className="inline-block bg-instagram-blue text-white px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition">
                Our Team
              </Link>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
            <div className="md:flex">
              ...
              <div className="p-8 md:w-2/3">
                ...
                <Link to="/blog" className="text-instagram-blue font-semibold hover:underline">Read More →</Link>
              </div>
            </div>
          </div>
        </div>
