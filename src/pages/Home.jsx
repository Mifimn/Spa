      ...
      <section className="relative h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <Fade direction="up" cascade damping={0.2} triggerOnce>
            ...
            <Link to="/services" className="bg-brand-gradient text-white px-8 py-4 rounded-lg text-lg font-semibold hover:opacity-90 transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Fade cascade damping={0.2} triggerOnce>
              {[
                ...
                { name: 'Scaling & Polishing', desc: 'Deep cleaning for healthy teeth', img: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=400&q=80' },
                { name: 'IV Drips', desc: 'Wellness and beauty infusions', img: 'https://images.unsplash.com/photo-1579154204601-01588f351e67?w=400&q=80' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Fade cascade damping={0.3} triggerOnce>
              {[
                ...
                <div key={idx} className="bg-cream-light p-6 rounded-lg h-full">
      ...
      <section className="py-16 bg-sage-primary text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Fade direction="up" triggerOnce>
            ...
            <Link to="/services" className="bg-white text-sage-primary px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cream-light transition">
              Book Now
            </Link>
          </Fade>
        </div>
