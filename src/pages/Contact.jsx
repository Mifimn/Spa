              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-instagram-blue ${
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <svg className="w-6 h-6 text-instagram-blue mt-1 mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
